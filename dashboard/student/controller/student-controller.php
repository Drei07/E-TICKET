...
class StudentController
{
    ...
    public function getTicket($eventIds, $courseId, $yearLevelId, $first_name, $middle_name, $last_name, $phone_number, $email)
    {
        ...
        $subject = "Ticket with Barcode";
        $message = "Hello $first_name,<br><br>Here is your ticket with the barcode attached.<br><br>Please present this ticket during the event.<br><br>Best regards,<br>Your Name";

       $ticket = $this->student->sendEmailWithBarcode($email, $message, $subject, $pdfContent, $this->smtp_email, $this->smtp_password, $this->system_name);
...
if (isset($_POST['btn-get-ticket'])) {
    ...
    $get_ticket = new StudentController();
    $get_ticket->getTicket($eventIds, $courseId, $yearLevelId, $first_name, $middle_name, $last_name, $phone_number, $email);
}
