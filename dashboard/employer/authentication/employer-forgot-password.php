...
if(isset($_POST['btn-forgot-password']))
{
 ...
 if($stmt->rowCount() == 1)
 {
  ...
  $message= "
       ...
       <br /><br />
       <a href='$main_url/dashboard/employer/authentication/employer-reset-password?id=$id&code=$code'>click here to reset your password</a>
       <br /><br />
       thank you :)
       ";
 ...
 else
 {
    ...
    header('Location: ../../../private/employer/forgot-password');
 }
}
?>