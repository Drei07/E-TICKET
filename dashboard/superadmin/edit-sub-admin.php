                    ...
                    <div class="modal-body">
                        <section class="data-form-modals">
                            <div class="registration">
                                ...
                                $department    = $sub_admin_data['department'];
                                ...
                                ?>
                                <form action="controller/user-controller.php?id=<?php echo $sub_admin_id ?>" method="POST" class="row gx-5 needs-validation" name="form" onsubmit="return validate()" novalidate style="overflow: hidden;">
                                    <div class="row gx-5 needs-validation">

                                        <div class="col-md-12">
                                            <label for="first_name" class="form-label">First Name<span> *</span></label>
                                            <input type="text" onkeyup="this.value = this.value.toUpperCase();" class="form-control" value="<?php echo $first_name ?>" autocapitalize="on" autocomplete="off" name="first_name" id="first_name" required>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" onkeyup="this.value = this.value.toUpperCase();" class="form-control" value="<?php echo $middle_name ?>" autocapitalize="on" autocomplete="off" name="middle_name" id="middle_name">
                                        </div>


                                        <div class="col-md-12">
                                            <label for="last_name" class="form-label">Last Name<span> *</span></label>
                                            <input type="text" onkeyup="this.value = this.value.toUpperCase();" class="form-control" value="<?php echo $last_name ?>" autocapitalize="on" autocomplete="off" name="last_name" id="last_name" required>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group flex-nowrap">
                                                ...
                                                <input type="text" class="form-control numbers" autocapitalize="off" inputmode="numeric" value="<?php echo $phone_number ?>" autocomplete="off" name="phone_number" id="phone_number" required minlength="10" maxlength="10" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" placeholder="10-digit number">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <select type="text" class="form-select form-control" name="department" id="department" required>
                                                <option selected value="<?php echo $department ?>"><?php  echo $department_data['department']?></option>
                                                <?php
                                    ...
                                    <div class="addBtn">
                                        <button type="submit" class="btn-dark" name="btn-edit-sub-admin" id="btn-add" onclick="return IsEmpty(); sexEmpty();">Update</button>
                                    </div>
                                </form>
                            </div>
                        </section>
