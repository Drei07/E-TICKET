...
function get_total_row($pdoConnect)
  {
    ...
    $pdoQuery = "SELECT COUNT(*) as total_rows FROM pdf_file WHERE event_id = :event_id";
    $pdoResult = $pdoConnect->prepare($pdoQuery);
    $pdoResult->execute(array(":event_id" => $eventId));
...
$query = "
SELECT * FROM pdf_file WHERE event_id = :event_id
";
$output = '';
if($_POST['query'] != '')
{
...
$statement->execute(array(":event_id" => $eventId));
