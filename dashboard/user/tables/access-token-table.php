...
{
  $pdoQuery = "SELECT COUNT(*) as total_rows FROM access_token WHERE user_id = :user_id";
  $pdoResult = $pdoConnect->prepare($pdoQuery);
  $pdoResult->execute(array(":user_id" => $_SESSION['sub_adminSession']));
...
$query = "
SELECT * FROM access_token WHERE user_id = :user_id
";
$output = '';
if($_POST['query'] != '')
{
  $query .= '
  AND token LIKE "%'.str_replace(' ', '%', $_POST['query']).'%"
  ';
}
