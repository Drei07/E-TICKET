...
<head>
    ...
    ?>
	<title>Track Me | Applied Jobs</title>
</head>
<body>
...
<div class="loader"></div>
	...
	<section id="content">
		...
		<!-- MAIN -->
		<main>
			<h1 class="title">Applied Jobs</h1>
			<ul class="breadcrumbs">
				<li><a href="./" >Home</a></li>
				<li class="divider">|</li>
                <li><a href="" class="active">Applied Jobs</a></li>
			</ul>
                ...
                <section id="jobs">
                    <div class="container">
                        <?php
                            ...
                            //save jobs
                            $save_jobs_stmt = $user->runQuery("SELECT * FROM application WHERE user_id=:user_id");
                            $save_jobs_stmt->execute(array(":user_id" => $user_id));
